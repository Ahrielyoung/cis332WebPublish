...
var data = {
  ...
  technews: {
    ...
    options: ['Big Tech says Australia rushed social media ban for youths under 16', 'TSMC founder Morris Chang offered top job to Jensen Huang memoir shows', 'Meta faces trial in October on unfair competition case lodged by Spanish media', 'Canadian news companies challenge OpenAI alleged copyright breaches', 'Australian social media ban started with call to act by politicians wife'],
    url: {
      link: [
        "https://www.reuters.com/technology/big-tech-says-australia-rushed-social-media-ban-youths-under-16-2024-11-29/",
        "https://www.reuters.com/technology/tsmc-founder-morris-chang-offered-top-job-jensen-huang-memoir-shows-2024-11-29/",
        "https://www.reuters.com/technology/meta-faces-trial-october-unfair-competition-case-lodged-by-spanish-media-2024-11-29/",
        ...
        "https://www.reuters.com/world/asia-pacific/australian-social-media-ban-started-with-call-act-by-poiliticans-wife-2024-11-29/"
      ]
    }
  },
  random: {
...
function handleOpt() {
  ...
  if (tempObj) {
    ...
    console.error("No data found for:", findText);
  }
}
